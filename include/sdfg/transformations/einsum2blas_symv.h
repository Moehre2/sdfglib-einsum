...
class Einsum2BLASSymv : public Transformation {
   ...
   public:
    Einsum2BLASSymv(einsum::EinsumNode& einsum_node);
    ...
    static Einsum2BLASSymv from_json(builder::StructuredSDFGBuilder& builder,
