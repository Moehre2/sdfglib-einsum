...
class Einsum2BLASAxpy : public Transformation {
    einsum::EinsumNode& einsum_node_;

   public:
    Einsum2BLASAxpy(einsum::EinsumNode& einsum_node);
    ...
    static Einsum2BLASAxpy from_json(builder::StructuredSDFGBuilder& builder,
