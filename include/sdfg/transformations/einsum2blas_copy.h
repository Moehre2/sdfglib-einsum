...
class Einsum2BLASCopy : public Transformation {
    einsum::EinsumNode& einsum_node_;

   public:
    Einsum2BLASCopy(einsum::EinsumNode& einsum_node);
    ...
    static Einsum2BLASCopy from_json(builder::StructuredSDFGBuilder& builder,
