...
class Einsum2BLASDot : public Transformation {
    einsum::EinsumNode& einsum_node_;

   public:
    Einsum2BLASDot(einsum::EinsumNode& einsum_node);
    ...
    static Einsum2BLASDot from_json(builder::StructuredSDFGBuilder& builder,
