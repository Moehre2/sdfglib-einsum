...
std::unique_ptr<data_flow::DataFlowNode> EinsumNode::clone(
        const graph::Vertex vertex, data_flow::DataFlowGraph& parent) const {
    return std::make_unique<EinsumNode>(this->debug_info(), vertex, parent,
