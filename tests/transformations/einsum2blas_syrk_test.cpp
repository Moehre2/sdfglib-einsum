...
TEST(Einsum2BLASSyrk, ssyrkLN_1) {
    ...
    transformations::Einsum2BLASSyrk transformation(*einsum_node);
...
TEST(Einsum2BLASSyrk, ssyrkLN_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, ssyrkUN_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, ssyrkUN_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, ssyrkLT_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
    ...
    EXPECT_EQ(blas_node->type(), blas::BLASType_real);
    EXPECT_EQ(blas_node->uplo(), blas::BLASTriangular_Lower);
    EXPECT_EQ(blas_node->trans(), blas::BLASTranspose_Transpose);
    EXPECT_EQ(blas_node->alpha(), "1.0f");
    EXPECT_EQ(blas_node->A(), "_in0");
    EXPECT_EQ(blas_node->C(), "_out");
    EXPECT_TRUE(symbolic::eq(blas_node->n(), bound_i));
...
TEST(Einsum2BLASSyrk, ssyrkLT_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, ssyrkUT_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, ssyrkUT_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkLN_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkLN_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkUN_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkUN_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkLT_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkLT_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkUT_1) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
...
TEST(Einsum2BLASSyrk, dsyrkUT_2) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
