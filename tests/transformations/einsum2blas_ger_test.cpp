...
TEST(Einsum2BLASGer, sger_1) {
    ...
    transformations::Einsum2BLASGer transformation(*einsum_node);
    ...
    auto* blas_node = dynamic_cast<blas::BLASNodeGer*>(libnode_opt);
