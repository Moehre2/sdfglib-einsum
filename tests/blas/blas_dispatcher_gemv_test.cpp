...
TEST(BLASDispatcherGemv, sgemvN) {
    ...
    EXPECT_EQ(generator.main().str(), R"(    {
        ...
        cblas_sgemv(CblasRowMajor, CblasNoTrans, m, n, _alpha, _A, n, _x, 1, 1.0f, _y, 1);
    }
)");
}

TEST(BLASDispatcherGemv, sgemvT) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
    ...
    EXPECT_EQ(generator.main().str(), R"(    {
        ...
        cblas_sgemv(CblasRowMajor, CblasTrans, m, n, _alpha, _A, n, _x, 1, 1.0f, _y, 1);
    }
)");
}

TEST(BLASDispatcherGemv, dgemvN) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
    ...
    EXPECT_EQ(generator.main().str(), R"(    {
        ...
        cblas_dgemv(CblasRowMajor, CblasNoTrans, m, n, _alpha, _A, n, _x, 1, 1.0, _y, 1);
    }
)");
}

TEST(BLASDispatcherGemv, dgemvT) {
    builder::StructuredSDFGBuilder builder("sdfg_1", FunctionType_CPU);
    ...
    EXPECT_EQ(generator.main().str(), R"(    {
        ...
        cblas_dgemv(CblasRowMajor, CblasTrans, m, n, _alpha, _A, n, _x, 1, 1.0, _y, 1);
    }
)");
}